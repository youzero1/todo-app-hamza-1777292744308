    ...
    <main className="min-h-screen flex flex-col items-center px-4 py-8 sm:py-16">
      <div className="w-full max-w-xl fade-in">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl todo-gradient shadow-lg shadow-indigo-500/30 mb-5 glow-pulse">
          ...
          <p className="text-slate-500 mt-2 text-sm font-medium">Stay organized, get things done.</p>
        </div>
