...
export default function TodoList() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-sm text-slate-500 mt-4 font-medium">Loading todos...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {error && (
        <div className="flex items-center gap-3 bg-red-500/10 backdrop-blur border border-red-500/20 text-red-400 text-sm rounded-2xl px-5 py-3">
      ...
      {usingLocal && (
        <div className="flex items-center gap-3 bg-amber-500/10 backdrop-blur border border-amber-500/20 text-amber-400 text-xs rounded-2xl px-5 py-3">
        ...
        <div className="flex items-center gap-3">
          <div className="flex-1 flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-slate-500">{completedCount} done</span>
            </div>
          </div>
          {/* Progress bar */}
          <div className="flex-1 h-1.5 bg-slate-800 rounded-full overflow-hidden">
            <div 
              className="h-full rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 transition-all duration-500 ease-out shadow-sm shadow-indigo-500/50"
      ...
      {/* Filter tabs */}
      <div className="flex gap-1 dark-card rounded-2xl p-1.5 shadow-sm shadow-black/20">
      ...
      {completedCount > 0 && (
        <div className="flex items-center justify-center pt-2">
          <button
            ...
            className="text-xs font-medium text-slate-500 hover:text-red-400 transition-colors duration-200 flex items-center gap-1.5 px-4 py-2 rounded-xl hover:bg-red-500/10"
          >
